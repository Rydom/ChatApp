...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            username = (TextView) itemView.findViewById(R.id.username_adapter);
            profile_image = (CircleImageView) itemView.findViewById(R.id.profile_image_adapter);
    ...
    private void lastMessage(final String userid, final TextView last_message){
        ...
        if(firebaseUser != null){//Tira o erro de object null quando realiza logout
